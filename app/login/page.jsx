    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 border rounded shadow">
            ...
            <Button
                type="button"
                onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
                className="flex items-center justify-center gap-2 border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 px-4 py-2 rounded shadow-md transition-all w-full"
            >
